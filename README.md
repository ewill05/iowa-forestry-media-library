# Iowa Forestry Media Library (IFML) - Website Source
...
## Tech Stack
* **Frontend:** Plain HTML5, CSS3 (No frameworks, lightweight).
* **Data Management:** Google Sheets embedded via iframe for real-time collection tracking.
* **Hosting:** GitHub Pages.
* **Asset Storage:** High-resolution TIFF/PNG assets are hosted on [Zenodo](https://zenodo.org/communities/ifml-archive).

## License
* **Website Code:** MIT License (Free to use/adapt the HTML structure).
